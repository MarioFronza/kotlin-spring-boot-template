...
import com.org.template.controllers.dto.SessionInput
import com.org.template.misc.utils.Constants.Companion.AUTHORIZATION
import com.org.template.misc.utils.Constants.Companion.BEARER
...
class JWTAuthenticationFilter : UsernamePasswordAuthenticationFilter {
    ...
    override fun attemptAuthentication(request: HttpServletRequest, response: HttpServletResponse?): Authentication? {
        try {
            val (email, password) = ObjectMapper().readValue(request.inputStream, SessionInput::class.java)
